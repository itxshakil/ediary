<template>
  <div>
    ...
    <dropdown v-cloak v-else>
        <img slot="toggler"
        class="flex text-sm border-2 focus:outline-none focus:border-white transition duration-150 ease-in-out text-gray-100 w-10 rounded-full" :src="user.profile.image" alt />
