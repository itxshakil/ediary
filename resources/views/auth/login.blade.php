...
@push('meta')
    ...
    <meta
        name="description"
        content="Log in to E-Diary now! Rated 4.8/5 by 1,524 users. Join for free and start writing your private thoughts today."
    />
    <meta
        name="keywords"
        content="secure diary login, E-Diary secure login, privacy-friendly login, highly-rated app, diary app login, shakil alam"
    />
    ...
    <meta
        ...
        content="Join thousands of satisfied users! Log in to E-Diary – the most secure and private way to track your thoughts and goals. Rated 4.8/5 by 1,524 happy users!"
    />
    ...
    <meta
        name="og:description"
        content="E-Diary is privacy-friendly and secure. Rated 4.8/5 by 1,524 users. Log in now to start your journey!"
    />
@endpush
    ...
    <script type="application/ld+json">
        {
            ...
            "publisher": {
                ...
                "sameAs": ["https://twitter.com/itxshakil", "https://www.linkedin.com/in/shakil-alam"]
            }
        }
    </script>
@endpush
            ...
            <div class="flex flex-col overflow-hidden rounded-3xl shadow-2xl lg:flex-row">
                ...
                <div class="w-full bg-white p-8 md:p-12 lg:w-1/2 dark:bg-gray-800">
                    ...
                    <div class="mb-8">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">Continue your journaling journey</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                                autofocus
                                class="mt-2 w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-3 text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
                            />
                            @error('username')
                        ...
                        <div>
                            <button
                                type="submit"
                                class="w-full rounded-xl bg-blue-600 px-4 py-3 font-semibold text-white shadow-md transition-all duration-200 hover:bg-blue-700"
                            >
                                Log In
                            </button>
                        </div>
                    ...
                    <div class="space-y-4">
                        <a
                            href="{{ route('register') }}"
                            class="flex w-full items-center justify-center rounded-xl border-2 border-blue-600 px-4 py-3 font-semibold text-blue-600 transition-all duration-200 hover:bg-blue-50 dark:border-blue-500 dark:text-blue-400 dark:hover:bg-blue-900/20"
                        >
                        ...
                        @if (Route::has('password.request'))
                            <div class="text-center">
                                <a
                                    href="{{ route('password.request') }}"
                                    class="inline-flex items-center gap-1 text-sm text-gray-600 transition-colors hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400"
                                >
