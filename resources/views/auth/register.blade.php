...
@push('meta')
    ...
    <meta
        name="description"
        content="Create your free E-Diary account today! Rated 4.8/5 by 1,524 users. Join the safest and most private online diary trusted by thousands worldwide."
    />
    <meta
        name="keywords"
        content="create diary account, free diary registration, secure diary signup, E-Diary register, start journaling, shakil alam"
    />
    ...
    <meta
        ...
        content="Start your journaling journey with E-Diary — secure, private, and trusted by 1,524+ users worldwide. Create your account for free today!"
    />
    ...
    <meta
        name="og:description"
        content="Join thousands of users who trust E-Diary for safe, private journaling. Create your free account today and start writing your story."
    />
@endpush
        ...
        <div class="w-full max-w-6xl">
            <div class="flex flex-col overflow-hidden rounded-3xl shadow-2xl lg:flex-row">
                ...
                <div class="w-full bg-white p-8 md:p-12 lg:w-1/2 dark:bg-gray-800">
                    ...
                    {{-- Header --}}
                    <div class="mb-8">
                        <h1 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Create Your Free Account</h1>
                        <p class="text-gray-600 dark:text-gray-400">Start your private journaling journey today</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-6">
                        ...
                        <button
                            type="submit"
                            class="w-full rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 py-3.5 font-semibold text-white shadow-md transition hover:scale-[1.01]"
                        >
                            Create Account
                        </button>
                    </form>
                    ...
                    <a
                        href="{{ route('login') }}"
                        class="flex w-full items-center justify-center rounded-xl border-2 border-blue-600 px-4 py-3 font-semibold text-blue-600 transition-all hover:bg-blue-50 dark:border-blue-500 dark:text-blue-400 dark:hover:bg-blue-900/20"
                    >
                        Log In Instead
                    </a>
                </div>
