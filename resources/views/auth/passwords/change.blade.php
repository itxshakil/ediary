...
@section('content')
    <div class="flex min-h-screen items-center justify-center bg-gray-100 px-4 py-12 dark:bg-gray-900">
        <div class="w-full max-w-4xl">
            <div class="flex overflow-hidden rounded-3xl bg-white shadow-xl dark:bg-gray-800">
                @include('auth.partials.left-branding')

                <div class="w-full p-8 sm:p-12 lg:w-1/2">
                    <div class="mb-8 text-center">
                        <h1 class="text-3xl font-semibold text-gray-900 dark:text-white">Change Password</h1>
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Update your account security</p>
                    </div>
