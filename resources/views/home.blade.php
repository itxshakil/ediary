...
<div class="container mx-auto px-3 md:px-6 my-4">
    ...
    <div id="notification-snackbar" class="bg-blue-700 text-white p-4 rounded max-w-72 fixed bottom-0 mb-4 mr-4 max-w-lg hidden transition-all duration-200 ease-in" role="alert" aria-live="assertive" aria-hidden="true">
