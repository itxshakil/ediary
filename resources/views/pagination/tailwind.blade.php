...
<div class="flex justify-center items-baseline">
    ...
    <a href="{{ $paginator->previousPageUrl() }}"
        class="text-blue-500 font-normal px-2 py-1 outline-none focus:outline-none mr-2    mb-1 hover:shadow-md inline-flex items-center font-bold text-xs"
    ...
    @else
    <a class="text-blue-500 font-normal px-2 py-1 outline-none focus:outline-none mr-2   mb-1 hover:shadow-md inline-flex items-center font-bold text-xs"
        href="{{ $url }}">{{ $page }}</a>
    @endif
    @endforeach
    @endif
